 ...
 * Date:7/26/23
 *
 * This progam implements a depth-first search algorithm through a graph without using recursion.
 * It then tests the method by creating a graph, calling the method, and printing out the results in order.
 */
